...
#include "com_tdhite_dnsqache_system_NativeTask.h"
...
Java_com_tdhite_dnsqache_system_NativeTask_getProp(JNIEnv *env, jclass class,
		jstring name)
{
...
Java_com_tdhite_dnsqache_system_NativeTask_runCommand(JNIEnv *env, jclass class,
		jstring command)
{
